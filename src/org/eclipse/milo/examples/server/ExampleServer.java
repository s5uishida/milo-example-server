...
public class ExampleServer {
    ...
    public ExampleServer() throws Exception {
        File securityTempDir = new File(uaConfig.getDir(), "security");
        ...
        UsernameIdentityValidator identityValidator = new UsernameIdentityValidator(
            ...
            authChallenge -> {
                ...
                boolean userOk = uaConfig.getUserName().equals(username) && uaConfig.getUserPassword().equals(password);
                boolean adminOk = uaConfig.getAdminName().equals(username) && uaConfig.getAdminPassword().equals(password);
    ...
    private Set<EndpointConfiguration> createEndpointConfigurations(X509Certificate certificate) {
        ...
        for (String bindAddress : bindAddresses) {
            for (String hostname : hostnames) {
                ...
                if (uaConfig.getTcpPortEnable()) {
                	endpointConfigurations.add(buildTcpEndpoint(noSecurityBuilder));
                }
                if (uaConfig.getHttpsPortEnable()) {
    ...
    private static EndpointConfiguration buildTcpEndpoint(EndpointConfiguration.Builder base) {
        return base.copy()
            ...
            .setBindPort(uaConfig.getTcpPort())
            .build();
    }
    ...
    private static EndpointConfiguration buildHttpsEndpoint(EndpointConfiguration.Builder base) {
        return base.copy()
            ...
            .setBindPort(uaConfig.getHttpsPort())
            .build();
    }
